 ...
 * @author rpbp
 */
public class DatosProfesionalDialog extends javax.swing.JDialog {

    /**
     * Creates new form DatosCuidadorDialog
     */
    public DatosProfesionalDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public DatosProfesionalDialog(MenuDialogProfesional view, boolean b) {
        initComponents();
        setLocationRelativeTo(null);
        setDefaultCloseOperation(JDialog.DO_NOTHING_ON_CLOSE);
