 ...
 * @author rpbp
 */
public class PersonalDataDialog extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public PersonalDataDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public PersonalDataDialog(PersonalMenuFrame view, boolean b) {
        initComponents();
        setLocationRelativeTo(null);
        setDefaultCloseOperation(JDialog.DO_NOTHING_ON_CLOSE);
        setResizable(false);
    ...
    //Métodos para obtener o cambiar valor a lo campos y bloquearlos o no.
