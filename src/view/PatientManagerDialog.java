 ...
 * @author rpbp
 */
public class PatientManagerDialog extends javax.swing.JDialog {

    /**
     * Creates new form clientManagerDialog
     */
    public PatientManagerDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        this.imprimirButton.setBackground(new Color(255, 255, 255));
    ...
    public void addPacienteScrollPaneMouseListener(MouseListener listener) {
        this.patientScrollPane.addMouseListener(listener);
    }
    ...
    //Métodos para gestionar la información de los componenetes así como su estado.
    ...
    private void initComponents() {
        ...
        patientScrollPane.setViewportView(pacienteTable);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(patientScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 638, Short.MAX_VALUE)
                .addContainerGap())
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(patientScrollPane, javax.swing.GroupLayout.PREFERRED_SIZE, 330, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(32, 32, 32)
