 ...
 * @author rpbp
 */
public class CaretakerDataDialog extends javax.swing.JDialog {

    /**
     * Creates new form DatosCuidadorDialog
     */
    public CaretakerDataDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public CaretakerDataDialog(CaretakerMenuFrame view, boolean b) {
        initComponents();
        setLocationRelativeTo(null);
        setDefaultCloseOperation(JDialog.DO_NOTHING_ON_CLOSE);
        setResizable(false);
    ...
    private void initComponents() {
        ...
        titleLabel.setFont(new java.awt.Font("Liberation Sans", 1, 20)); // NOI18N
    ...
    //Métodos para obtener, editar valores de los componentes y bloquearlos.
