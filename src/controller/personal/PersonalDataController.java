...
public class PersonalDataController {
    ...
    private final PersonalDataDialog view;
    private UserLogin userLogin;

    public PersonalDataController(PersonalDataDialog view, UserLogin userLogin) {
        this.view = view;
    ...
    //Válida el teléfono para que siga el formato establecido.
    public boolean validarTelefono(String telefono) {
        return telefono.matches("\\d{9}");
    }

    //Válida el dni para que siga el formato establecido.
    ...
    //Válida el email para que siga el formato establecido.
    public boolean validarEmail(String email) {
        return email.matches("^[\\w.-]+@[\\w.-]+\\.[a-zA-Z]{2,}$");
    }

    //Válida que los campos estén cubiertos.
    ...
    //Inicia los componentes de la manera indicada.
    ...
    //Activa los campos para editar los datos.
