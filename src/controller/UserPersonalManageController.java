...
import view.UserPersonalManageJDialog;

/**
 *
 * @author rpbp
 */
public class UserPersonalManageController {

    private final UserPersonalManageJDialog view;
    private UserLogin userLogin;
    private boolean edit;

    public UserPersonalManageController(UserPersonalManageJDialog view, UserLogin userLogin) throws SQLException {
            ...
            public void mouseClicked(MouseEvent e) {
                if (view.getCellInfo().isEmpty() == false) {
                    ...
                    try {
                        ...
                        Logger.getLogger(UserPersonalManageController.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            }
