 ...
 * @author rpbp
 */
public class TareaManagePersonalController {

    private final TareasManagerPersonalDialog view;
    private UserLogin userLogin;
    private boolean edit;

    public TareaManagePersonalController(TareasManagerPersonalDialog view, UserLogin userLogin) throws SQLException {
    ...
    public void print() throws IOException, SQLException {
        ...
        try {
            ...
            JasperReport report = JasperCompileManager.compileReport(
                    ClientManageController.class.getClassLoader().getResourceAsStream("reports/TareasPersonal.jrxml")
            );
        ...
        MouseListener al = new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                try {
                    ...
                    Logger.getLogger(TareaManagePersonalController.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
