...
public class TaskManagerController {
    ...
    private final TaskManagerDialog view;
    private UserLogin userLogin;
    private boolean edit;

    public TaskManagerController(TaskManagerDialog view, UserLogin userLogin) throws SQLException {
        ...
        MouseListener al = new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                try {
                    ...
                    Logger.getLogger(TaskManagerController.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    //Método para comprobar si la tarea existe
    ...
    //Método para obtener la información de la selección de la tabla
